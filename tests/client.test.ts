...
const SUCCESS = {
  ...
  contacts: [{ input: "5514997207735", wa_id: "5514997207735" }],
...
describe("WhatsApp Client", () => {
  ...
  it("should send text message with correct payload", async () => {
    ...
    const result = await client.sendText("5514997207735", "Hello!")
  ...
  it("should send text with previewUrl enabled", async () => {
    ...
    await client.sendText("5514997207735", "Check https://example.com", { previewUrl: true })
  ...
  it("should send text with replyTo context", async () => {
    ...
    await client.sendText("5514997207735", "Reply!", { replyTo: "wamid.original" })
  ...
  it("should send image with URL", async () => {
    ...
    await client.sendImage("5514997207735", { url: "https://example.com/img.jpg" }, "Nice photo")
  ...
  it("should send image with media ID", async () => {
    ...
    await client.sendImage("5514997207735", { id: "media-id-123" })
  ...
  it("should send audio with URL", async () => {
    ...
    await client.sendAudio("5514997207735", { url: "https://example.com/audio.ogg" })
  ...
  it("should send video with caption", async () => {
    ...
    await client.sendVideo("5514997207735", { url: "https://example.com/vid.mp4" }, "Watch this")
  ...
  it("should send video without caption", async () => {
    ...
    await client.sendVideo("5514997207735", { id: "video-id" })
  ...
  it("should send document with filename and caption", async () => {
    ...
    await client.sendDocument("5514997207735", { url: "https://example.com/doc.pdf" }, "invoice.pdf", "Your invoice")
  ...
  it("should send sticker with media ID", async () => {
    ...
    await client.sendSticker("5514997207735", { id: "sticker-id" })
  ...
  it("should send location with all fields", async () => {
    ...
    await client.sendLocation("5514997207735", {
      lat: -23.5505,
      lng: -46.6333,
      name: "Sao Paulo",
  ...
  it("should send contacts", async () => {
    ...
    await client.sendContacts("5514997207735", contacts)
  ...
  it("should send reaction emoji", async () => {
    ...
    await client.sendReaction("5514997207735", "wamid.target", "\u{1F44D}")
  ...
  it("should remove reaction with empty emoji", async () => {
    ...
    await client.removeReaction("5514997207735", "wamid.target")
  ...
  it("should throw WhatsAppError on 500 with empty body", async () => {
    ...
    await expect(client.sendText("5514997207735", "Hi")).rejects.toThrow(WhatsAppError)
  })
  ...
  it("should send buttons without header/footer", async () => {
    ...
    await client.sendButtons("5514997207735", "Pick one", [
  ...
  it("should send product message with body text", async () => {
    ...
    await client.sendProduct("5514997207735", "catalog-001", "product-abc", "Check this out!")
  ...
  it("should send product message without body text", async () => {
    ...
    await client.sendProduct("5514997207735", "catalog-001", "product-abc")
  ...
  it("should use custom API version in URL", async () => {
    ...
    await client.sendText("5514997207735", "Hello")
